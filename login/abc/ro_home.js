...
$(function() {
  ...
  $("#sign-up-link").click(function() {
    ...
    $("#smirk-signup-form").show().css({height: 300});
    ...
    $(this).empty();
    $(this).append(
      $("<img src='abc/btn-close-login-up.png'>").click(function(e) {
        e.stopPropagation();
       	$(".tab-selected").removeClass("tab-selected").addClass("tab");
    ...
    $("#sign-in-drawer").css({overflow: "hidden", height: 1}).show().animate({height: 300}) 
  ...
  $("#log-in-link").click(function() {
    ...
    $("#sign-in-drawer").css({overflow: "hidden", height: 1}).show().animate({height: 250})
