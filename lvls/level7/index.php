...
elseif($_SESSION['level'] < 7) header("location:../../error.php");
?>
...
<body >	
 ...
 <?php include("../slider.php"); ?>
   <div id="box" style="margin-left:30%;margin-top:2%;margin-right:30%;display:block;width:40%;height:20px%;text-align:center;color:#000"><br><h2><u>Level 7</u></h2></div> 
 ...
 <div style="margin-left:auto;margin-right:auto;padding-top:20px;padding-right:20px;padding-bottom:20px;padding-left:20px;height:90%;background-color:#FFF;width:70%;border:thin #666;border:thin rgba(0,0,0,0.3) solid;box-shadow: 0px 5px 20px #999;"> 
  <img src="agent_smith.jpg" width="45%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="spongebob.jpg" height="45%"><br><br>
  <img src="spock.jpg" width="40%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 </div>
  <div>
  </h2>
  <form method="post" action="../check.php" onSubmit="return validateForm()" >
  <input id="answer" type="text" name="solution_level_7"><br><br>
